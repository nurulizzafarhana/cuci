                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
                                                    <td><?php echo $rowUser['customer_name'] ?></td>
                                                    <td><?php echo $rowUser['phone'] ?></td>
                                                    <td><?php echo $rowUser['address'] ?></td>
                                                    <td>
                                                        <a href="tambah-customer.php?edit=<?php echo $rowUser['id'] ?>" class="btn btn-success btn-sm">
                                                            <span class="tf-icon bx bx-pencil bx-18px"></span>
                                                        </a>
                                                        <a onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')" href="customer.php?delete=<?php echo $rowUser['id'] ?>" class="btn btn-danger btn-sm">
