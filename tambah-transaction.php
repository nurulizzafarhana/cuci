...
//     mysqli_query($koneksi, "UPDATE trans_order SET id_customer='$id_customer', order_code='$order_code', order_date='$order_date', order_status='$order_status' WHERE id='$id'");
...
//     $id = $_GET['delete'];
//     mysqli_query($koneksi, "DELETE FROM trans_order WHERE id='$id'");
